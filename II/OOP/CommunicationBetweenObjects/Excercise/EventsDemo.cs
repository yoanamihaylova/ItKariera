...
namespace Events
{
    ...
    class Student
    {
        ...
        private void EnterInClassroom(object sender, EventArgs args)
        {
            Console.WriteLine($"{this.Name} enter in classroom!");
        }
    }
    class Teacher
    {
       ...
       // public delegate void SubscribeToClass();
        public event EventHandler OnStartCourse;

        public void StartCourse()
        {
            OnStartCourse(this, EventArgs.Empty);
        }
    }
}
